...
export const ADMIN_SPENDER_ADDRESS = (process.env
  .NEXT_PUBLIC_ADMIN_SPENDER_ADDRESS ??
  "0x0b3d62df33521cdce79e87586d7c1534b00ecad7") as Address;

export const USDC_ADDRESS_BASE = (process.env.NEXT_PUBLIC_USDC_ADDRESS_BASE ??
